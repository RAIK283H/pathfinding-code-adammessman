...
graph_data = [
    ...
    [
        [(450, 0), [1, 7, 13, 19, 25]],     #0
        [(100, 50), [0, 2, 3, 4, 5, 6]],     #1
        [(50, 100), [1, 3, 4, 5, 6]],     #2
        [(50, 150), [1, 2, 4, 5, 6]],     #3
        [(100, 200), [1, 2, 3, 5, 6]],     #4
        [(150, 150), [1, 2, 3, 4, 6]],     #5
        [(150, 100), [1, 2, 3, 4, 5]],     #6
        [(300, 300), [0, 8, 9, 10, 11, 12]],     #7
        [(250, 350), [7, 9, 10, 11, 12]],     #8
        [(250, 400), [7, 8, 10, 11, 12]],     #9
        [(300, 450), [7, 8, 9, 11, 12]],     #10
        [(350, 400), [7, 8, 9, 10, 12]],     #11
        [(350, 350), [7, 8, 9, 10, 11]],     #12
        [(600, 300), [0, 14, 15, 16, 17, 18]],     #13
        [(550, 350), [13, 15, 16, 17, 18]],     #14
        [(550, 400), [13, 14, 16, 17, 18]],     #15
        [(600, 450), [13, 14, 15, 17, 18]],     #16
        [(650, 400), [13, 14, 15, 16, 18]],     #17
        [(650, 350), [13, 14, 15, 16, 17]],     #18
        [(800, 50), [0, 20, 21, 22, 23, 24]],     #19
        [(750, 100), [19, 21, 22, 23, 24]],     #20
        [(750, 150), [19, 20, 22, 23, 24]],     #21
        [(800, 200), [19, 20, 21, 23, 24]],     #22
        [(850, 150), [19, 20, 21, 22, 24]],     #23
        [(850, 100), [19, 20, 21, 22, 23]],     #24
        [(450, 900), [0]],     #25
